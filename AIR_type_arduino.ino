...
void loop()
{
    ...
    deg1 = map(sensor1, 261,544 , 0, 1024);
    deg2 = map(sensor2, 261,544 , 0, 1024);
    deg3 = map(sensor3, 261,544 , 0, 1024);
    deg4 = map(sensor4, 261,544 , 0, 1024);
    deg5 = map(sensor5, 261,544 , 0, 1024);
    deg6 = map(sensor6, 261,544 , 0, 1024);
    deg7 = map(sensor7, 261,544 , 0, 1024);
    deg8 = map(sensor8, 261,544 , 0, 1024);
